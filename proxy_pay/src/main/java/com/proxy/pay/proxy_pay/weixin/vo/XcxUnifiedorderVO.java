package com.proxy.pay.proxy_pay.weixin.vo;

public class XcxUnifiedorderVO {
	...
	public String toString() {
		return "XcxUnifiedorderVO [return_code=" + return_code + ", return_msg=" + return_msg + ", appid=" + appid
